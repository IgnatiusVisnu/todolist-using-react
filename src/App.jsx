...
export default function All() {
  ...
  return (
    // dibikin kelas 'entire' yg mencakup semua elemen, soalnya body ga bisa diotak atik atau dikasih data theme
...
function App({theme, onPlay}) {
  ...
  // const history buat copy const items yg tidak terpengaruh fitur tombol all, completed, dan active
  ...
  // inget, kalo ga jalan ilangin REACTStrictMode di main.jsx
...
function Form({onAddItem}) {
  ...
  function handleSubmit(e) {
    // ada parameter e yg diambil buat bikin e.preventDefault(), biar halaman ga refresh pas list nya nambah
    e.preventDefault()
    if (!name) return
    // id nya dibikin string biar bisa kebaca fitur drag and drop
